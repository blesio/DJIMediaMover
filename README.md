...
During active copies, the progress window displays application-level transfer throughput calculated from bytes successfully written to the resumable partial file.
